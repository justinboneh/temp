...
// configuration step. It creates a namespace called `temp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", temp::cmake::project_name, temp::cmake::project_version) };
